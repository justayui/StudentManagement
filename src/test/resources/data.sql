...
INSERT INTO student_course_status(course_id,status)
VALUES (1, 'MAIN_APPLICATION'),
       (2, 'TEMPORARY_APPLICATION'),
       (3, 'TEMPORARY_APPLICATION'),
       (4, 'TEMPORARY_APPLICATION'),
       (5, 'TEMPORARY_APPLICATION'),
       (6, 'TEMPORARY_APPLICATION'),
       (7, 'TEMPORARY_APPLICATION'),
       (8, 'TEMPORARY_APPLICATION'),
       (9, 'TEMPORARY_APPLICATION')
